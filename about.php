...
<head>
    ...
    <header>
        <section class="abouthero hero containerfw ">
            <div class="container herogrid">
                <h1 class="herotitle">About Me</h1>
            </div>
        </section>
    </header>
<section class="container banner">
    <h1 class="bannertitle m-b-1">Some of the treatments I provide</h1>
...
The look can vary from subtle, being Classic to extremely dramatic with Extreme Mega Volume.
                ...
                <ul class="fa-ul content">
                    ...
                    <li><span class="fa-li"><i class="fas fa-check"></i></span>Fresh Infills</li>
                </ul>
            </div>
        </div>
...
Finished alongside with a relaxing prescription facial using Eve Taylor Products, this is a lovely relaxing treatment.
                ...
                <ul class="fa-ul content textbox-text">
                    ...
                    <li><span class="fa-li"><i class="fas fa-check"></i></span>Creates healthier, more radiant appearance</li>
                </ul>
            </div>
        </div>
